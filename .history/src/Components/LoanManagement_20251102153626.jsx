...
function LoanManagement({ books, loans, onAddLoan, onReturnLoan }) {
    ...
    const availableBooks = books.filter(
        (book) => !loans.some((loan) => loan.bookId === (book.isbn13 || book.title))
    );
    ...
    const getBookTitle = (bookId) => {
        const book = books.find((book) => (book.isbn13 || book.title) === bookId);
    ...
    return (
        <div className="loan-management">
            <div className="loan-form-container">
                {allBooksLoaned ? (
                    <div className="all-books-loaned-message">
                        ...
                        <p>Please wait for books to be returned before creating new loans.</p>
                    </div>
                ) : (
            ...
            <div className="loaned-books-list">
                <h2>Loaned Books</h2>
                {loans.length === 0 ? (
                    <p className="no-loans-message">No books are currently on loan.</p>
                ) : (
